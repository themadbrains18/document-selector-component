...
const Unions = () => {
    ...
    return (
        <div className='py-6  border-b border-gray-200 '>
            <p className='text-sm text-gray-900 font-inter font-medium mb-2'>
                Is Jason Smith a member (or required to be a member, for this role) of any union(s)?
            </p>
                ...
                <RadioGroup.Option value='yes'>
                    {({ checked }) => (
                        <div className='flex gap-2 items-center cursor-pointer'>
                            <span
                                className={`inline-block w-4 h-4 rounded-full  bg-gray-50 border-[0.5px] border-gray-300 ${checked ? 'border-[3.5px] border-orange-500' : ''
                                    }`}
                            ></span>
            ...
            {plan === 'yes' && (
                <div className='max-w-[400px] w-full relative'>
                    ...
                    <div
                        className='border border-gray-300 rounded-lg px-2.5 py-2 flex justify-between gap-2.5 items-center cursor-pointer'
                    ...
                    <ul
                        className={`border border-gray-200 rounded-lg shadow-md p-1.5 mt-0.5 duration-300 absolute bg-white w-full ${toggle ? 'opacity-100 visible' : 'opacity-0 invisible '
                            }`}
                    >
                        {unions?.map(({ id, unionName }) => (
                            <li
                                key={unionName}
                                className='first:border-b first:border-gray-200 first:mb-1'
                                onClick={() => {
                                    setSelected(unionName);
                                    setToggle(false);
                                    setUnionId(id);
                                }}
                            >
                        ...
                        <>
                            <div className='border-b-[2px] border-gray-200 py-4'>
                                <div className='p-4 rounded-md bg-blue-50 border border-blue-200'>
                                    <p className='text-sm text-primary-800 font-inter'>
                                        If the union list above doesn’t feature a particular union relevant to your firm, please contact Mason Support and we’ll partner with you to get the relevant union agreements and conditions imported into our system
                                    </p>
                                </div>
                            </div>
                        ...
                        <>
                            ...
                            <div className='mt-4'>
                                ...
                                <div className='border-b-[2px] border-gray-200 py-4'>
                                    <div className='p-4 rounded-md bg-blue-50 border border-blue-200'>
                                        <p className='text-sm text-primary-800 font-inter'>
                                            We’re still working on setting up the back-end logic to accurately reflect this union’s agreements and conditions. If you selected a union in this list, we’re already working with your firm to get that resolved!
                                        </p>
                                        <p className='text-sm text-primary-800 font-inter'>
                                            If you have any questions please contact Mason Support.
                                        </p>
                                    </div>
                                </div>
